...
def generate_creative_with_gemini_image(gemini_client, brand_name, industry, visual_context):
    """
    Acts as the Photographer/Artist: Uses 'gemini-3.1-flash-lite-image' to render
    ...
    print(f"  🎨 Generating high-fidelity visual creative for {brand_name} using gemini-3.1-flash-lite-image...")
    ...
    try:
        ...
        print(f"   Error generating image with gemini-3.1-flash-lite-image: {e}")
        return None
# --- Email Sending ---
